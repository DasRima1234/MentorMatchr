          ...
          <table class="table table-striped">
            ...
            <tr>
              <td colspan="2">
                ...
                @if(in_array($operator->operator_id, $activeUserOperatorsArray))
                <div class="row">
                  <div class="col-md-10 custom-control custom-checkbox  " onclick="assingservicescheck({{$operator->operator_id}})">
