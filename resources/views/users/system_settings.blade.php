                                ...
                                <div class="card setting-card">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 text-right">
                                            <button type="submit" class="btn btn-md badge-red text-xs rounded">Submit</button>
                    ...
                    <form id="setting-form" method="post" action="{{route('settings.store')}}">
                        ...
                        <div class="card bg-none">
                            <div class="row company-setting">
                                ...
                                <div class="form-group col-md-12 text-right">
                                    <input type="submit" id="save-btn" value="{{__('Save Changes')}}" class="btn-create badge-red">
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="tab-pane fade" id="company-payment-setting" role="tabpanel" aria-labelledby="contact-tab4">
                    ...
                    <form id="setting-form" method="post" action="{{route('payment.settings')}}">
                        ...
                        <div class="card-footer text-right">
                            <div class="form-group">
                                <input class="btn-create badge-red" type="submit" value="{{__('Save Changes')}}">
                            </div>
                        </div>
                    </form>
                </div>
