...
<div class="row">
    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-12">
        <div class="card profile-card">
            ...
            <div class="sal-right-card">
                <span class="badge badge-pill badge-red">{{ $user->type }}</span>
            </div>
    ...
    <div class="col-lg-12 text-right">
        <input type="submit" value="{{__('Save Changes')}}" class="btn-create badge-red">
    </div> --}}
</div>
</form>
@if($user->avatar!='')
...
<div id="change_password" class="tab-pane">
    <form method="post" action="{{route('update.userpassword')}}">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 text-right">
                <input type="submit" value="{{__('Change Password')}}" class="btn-create badge-red">
            </div>
        </div>
    </form>
</div>
...
<div class="card profile-card" style="display: block; color: #000;">
    <div style="font-weight: bold; font-size: 22px; padding-left: 5px;  padding-left: 17px; margin-bottom: 20px;"> Work here</div>
    <div class="row">
