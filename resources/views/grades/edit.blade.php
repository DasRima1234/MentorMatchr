...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="mb-4">{{ __('Edit Grade Information') }}</h4>

                {!! Form::model($grade, ['route' => ['grades.update', $grade->id], 'method' => 'PUT']) !!}
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12 text-right">
                        <button type="submit" class="btn btn-primary">{{ __('Update Grade') }}</button>
